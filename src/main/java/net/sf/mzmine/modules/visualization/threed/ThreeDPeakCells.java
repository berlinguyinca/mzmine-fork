...
public class ThreeDPeakCells extends CellImpl {
	 ...
	 *             if there are VisAD problems.
	 */
	public void setPeaks(final ChromatographicPeak[] thePeaks)
	...
	private Data createPeakBox(final ChromatographicPeak peak)
		...
		return GriddedSet.create(pointTupleType, new float[][]{
				{rtMin, rtMax, rtMin, rtMax, rtMin, rtMax, rtMin, rtMax, rtMin,
						rtMin, rtMin, rtMin, rtMax, rtMax, rtMax, rtMax,},
				{mzMin, mzMin, mzMin, mzMin, mzMax, mzMax, mzMax, mzMax, mzMin,
						mzMax, mzMin, mzMax, mzMin, mzMax, mzMin, mzMax},
