...
public class UserParameterOpenHandler_2_5_FiehnlabFork extends DefaultHandler
		implements
	...
	public UserParameterOpenHandler_2_5_FiehnlabFork(MZmineProject newProject,
	...
	public void startElement(String namespaceURI, String lName, String qName,
		...
		// <PARAMETERS>
		if (qName.equals(UserParameterElementName_2_5_FiehnlabFork.PARAMETERS
				.getElementName())) {
			String count = attrs
					.getValue(UserParameterElementName_2_5_FiehnlabFork.COUNT
							.getElementName());
			totalParams = Integer.parseInt(count);
		}

		// <PARAMETER>
		if (qName.equals(UserParameterElementName_2_5_FiehnlabFork.PARAMETER
				.getElementName())) {

			String name = attrs
					.getValue(UserParameterElementName_2_5_FiehnlabFork.NAME
							.getElementName());
			String type = attrs
		...
		if (qName.equals(UserParameterElementName_2_5_FiehnlabFork.VALUE
			...
			currentDataFileID = attrs
					.getValue(UserParameterElementName_2_5_FiehnlabFork.DATA_FILE
							.getElementName());
		}
	...
	public void endElement(String namespaceURI, String sName, String qName)
		...
		// <OPTION>
		if (qName.equals(UserParameterElementName_2_5_FiehnlabFork.OPTION
				.getElementName())) {
