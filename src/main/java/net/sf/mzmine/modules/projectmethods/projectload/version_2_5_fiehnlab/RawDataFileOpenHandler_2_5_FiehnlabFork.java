...
public class RawDataFileOpenHandler_2_5_FiehnlabFork extends DefaultHandler
		implements
	...
	private boolean isCorrectedSpectrum;
	private CombinedRegression fit = null;
	private Map<String, FameCorrection> partialCorrectionResults = null;
	private List<Double> xdata = null, ydata = null;
	private double originalRetentionTime;
	...
	public void startElement(String namespaceURI, String lName, String qName,
		...
		if (qName
				.equals(RawDataElementName_2_5_FiehnlabFork.QUANTITY_FRAGMENT_SCAN
						.getElementName())) {
			numberOfFragments = Integer.parseInt(attrs
					.getValue(RawDataElementName_2_5_FiehnlabFork.QUANTITY
							.getElementName()));
		...
		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.SCAN
			...
			currentStorageID = Integer.parseInt(attrs
					.getValue(RawDataElementName_2_5_FiehnlabFork.STORAGE_ID
							.getElementName()));
		}

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.STORED_DATA
				.getElementName())) {
			...
			storedDataNumDP = Integer
					.parseInt(attrs
							.getValue(RawDataElementName_2_5_FiehnlabFork.QUANTITY_DATAPOINTS
									.getElementName()));
		}

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.MASS_LIST
				.getElementName())) {
			String name = attrs
		...
		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.CORRECTION_FIT
				.getElementName())) {
		...
		if (qName
				.equals(RawDataElementName_2_5_FiehnlabFork.CORRECTION_FIT_DATA
						.getElementName())) {
			double x = Double.parseDouble(attrs
					.getValue(RawDataElementName_2_5_FiehnlabFork.XDATA
							.getElementName()));
			double y = Double.parseDouble(attrs
					.getValue(RawDataElementName_2_5_FiehnlabFork.YDATA
							.getElementName()));
			xdata.add(x);
			ydata.add(y);
		}

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.CORRECTION_RESULTS
				.getElementName()))
			partialCorrectionResults = new TreeMap<String, FameCorrection>();

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.CORRECTION_DATA
				.getElementName())) {
			String name = attrs
					.getValue(RawDataElementName_2_5_FiehnlabFork.NAME
							.getElementName());
	...
	public void endElement(String namespaceURI, String sName, String qName)
		...
		// <NAME>
		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.NAME
				.getElementName())) {
		...
		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.QUANTITY_SCAN
				.getElementName())) {
			numberOfScans = Integer.parseInt(getTextOfElement());
		}

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.SCAN_ID
				.getElementName())) {
		...
		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.MS_LEVEL
				.getElementName())) {
			msLevel = Integer.parseInt(getTextOfElement());
		}

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.PARENT_SCAN
				.getElementName())) {
			parentScan = Integer.parseInt(getTextOfElement());
		}

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.PRECURSOR_MZ
				.getElementName())) {
			precursorMZ = Double.parseDouble(getTextOfElement());
		}

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.PRECURSOR_CHARGE
				.getElementName())) {
			precursorCharge = Integer.parseInt(getTextOfElement());
		}

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.RETENTION_TIME
				.getElementName())) {
		...
		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.CENTROIDED
				.getElementName())) {
			centroided = Boolean.parseBoolean(getTextOfElement());
		}

		if (qName
				.equals(RawDataElementName_2_5_FiehnlabFork.QUANTITY_DATAPOINTS
						.getElementName())) {
			dataPointsNumber = Integer.parseInt(getTextOfElement());
		}

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.FRAGMENT_SCAN
				.getElementName())) {
		...
		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.CORRECTED_SPECTRUM
				.getElementName()))
			isCorrectedSpectrum = (Integer.parseInt(getTextOfElement()) == 1);

		if (qName
				.equals(RawDataElementName_2_5_FiehnlabFork.ORIGINAL_RETENTION_TIME
						.getElementName()))
			originalRetentionTime = Double.parseDouble(getTextOfElement());

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.RETENTION_INDEX
				.getElementName()))
			retentionIndex = Double.parseDouble(getTextOfElement());

		if (qName.equals(RawDataElementName_2_5_FiehnlabFork.UNIQUE_MASS
				.getElementName()))
			uniqueMass = Double.parseDouble(getTextOfElement());
	}
