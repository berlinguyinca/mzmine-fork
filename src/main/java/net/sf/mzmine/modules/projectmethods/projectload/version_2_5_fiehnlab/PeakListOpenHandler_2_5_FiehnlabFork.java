...
public class PeakListOpenHandler_2_5_FiehnlabFork extends DefaultHandler
		implements
			PeakListOpenHandler {
	...
	public PeakListOpenHandler_2_5_FiehnlabFork(
	...
	public void startElement(String namespaceURI, String lName, String qName,
		...
		// <ROW>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.ROW
				.getElementName())) {
			...
			int rowID = Integer.parseInt(attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.ID
							.getElementName()));
			buildingRow = new SimplePeakListRow(rowID);
			String comment = attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.COMMENT
							.getElementName());
			buildingRow.setComment(comment);
		}

		// <PEAK_IDENTITY>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.PEAK_IDENTITY
				.getElementName())) {
			identityProperties = new Hashtable<String, String>();
			preferred = Boolean.parseBoolean(attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.PREFERRED
							.getElementName()));
		}

		// <IDENTITY_PROPERTY>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.IDPROPERTY
				.getElementName())) {
			identityPropertyName = attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.NAME
							.getElementName());
		}

		// <PEAK>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.PEAK
				.getElementName())) {

			peakColumnID = attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.COLUMN
							.getElementName());
			mass = Double.parseDouble(attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.MZ
							.getElementName()));
			// Before MZmine 2.6 retention time was saved in seconds, but now we
			// use minutes, so we need to divide by 60
			rt = Double.parseDouble(attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.RT
							.getElementName())) / 60d;
			height = Double.parseDouble(attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.HEIGHT
							.getElementName()));
			area = Double.parseDouble(attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.AREA
							.getElementName()));
			peakStatus = attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.STATUS
							.getElementName());
			String chargeString = attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.CHARGE
							.getElementName());
		...
		// <MZPEAK>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.MZPEAKS
				.getElementName())) {
			numOfMZpeaks = Integer.parseInt(attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.QUANTITY
							.getElementName()));
		}

		// <ISOTOPE_PATTERN>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.ISOTOPE_PATTERN
				.getElementName())) {
			...
			currentIsotopePatternDescription = attrs
					.getValue(PeakListElementName_2_5_FiehnlabFork.DESCRIPTION
							.getElementName());
		}
	...
	public void endElement(String namespaceURI, String sName, String qName)
		...
		// <NAME>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.PEAKLIST_NAME
				.getElementName())) {
		...
		// <PEAKLIST_DATE>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.PEAKLIST_DATE
				.getElementName())) {
			dateCreated = getTextOfElement();
		}

		// <QUANTITY>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.QUANTITY
				.getElementName())) {
		...
		// <RAW_FILE>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.RAWFILE
				.getElementName())) {
		...
		// <SCAN_ID>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.SCAN_ID
				.getElementName())) {
		...
		// <REPRESENTATIVE_SCAN>
		if (qName
				.equals(PeakListElementName_2_5_FiehnlabFork.REPRESENTATIVE_SCAN
						.getElementName())) {
		...
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.FRAGMENT_SCAN
				.getElementName())) {
			fragmentScan = Integer.valueOf(getTextOfElement());
		}

		// <MASS>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.MZ
				.getElementName())) {
		...
		// <HEIGHT>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.HEIGHT
				.getElementName())) {
		...
		// <ISOTOPE>
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.ISOTOPE
				.getElementName())) {
			String text = getTextOfElement();
		...
		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.METHOD_NAME
				.getElementName())) {
			String appliedMethod = getTextOfElement();
			appliedMethods.add(appliedMethod);
		}

		if (qName.equals(PeakListElementName_2_5_FiehnlabFork.METHOD_PARAMETERS
				.getElementName())) {
